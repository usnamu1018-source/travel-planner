...
async function generateItinerary(lat, lng) {
    ...
    const apiKey = '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'; 
    ...
    try {
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            body: JSON.stringify({
                model: 'gpt-3.5-turbo', // 또는 gpt-4o-mini (저렴함)
